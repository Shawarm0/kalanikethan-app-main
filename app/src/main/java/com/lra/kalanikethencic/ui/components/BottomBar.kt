...
import com.lra.kalanikethencic.util.topBorder
...
fun TabBar(
    ...
    Row(
        ...
        TabItem(
            ...
            modifier = if (selectedTab == Tab.Student) Modifier.topBorder(3.dp, MaterialTheme.colorScheme.outline) else Modifier,
        ...
        TabItem(
            ...
            modifier = if (selectedTab == Tab.Parents) Modifier.topBorder(3.dp, MaterialTheme.colorScheme.outline) else Modifier,
        ...
        TabItem(
            ...
            modifier = if (selectedTab == Tab.Payments) Modifier.topBorder(3.dp, MaterialTheme.colorScheme.outline) else Modifier,
