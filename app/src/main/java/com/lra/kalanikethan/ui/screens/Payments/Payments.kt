    ...
    LazyColumn(
        ...
        items(unpaidFamilies){ family ->
            val paymentData = PaymentData(
                ...
                amount = family.currentPayment.amount.toString()
            )
            PaymentComponent(
                data = paymentData,
                onConfirmClick = {
                    paymentViewModel.confirmPayment(family.currentPayment.payment_id as Int, family.currentPayment.family_payment_id, family.currentPayment.amount)
                },
                onViewHistoryClick = {
